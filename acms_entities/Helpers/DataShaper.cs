...
namespace AccessManagementSystem.Entities.Helpers
{
    public class DataShaper<T> : IDataShaper<T>
    {
        ...
        private ShapedEntity FetchDataForEntity(T entity, IEnumerable<PropertyInfo> requiredProperties)
        {
            ...
            if (entity is AccessSetting)
            {
                var shapedSupplierOfferEntity = new ShapedAccessSettingEntity();

                var objectProperty = entity.GetType().GetProperty("ElectronicLockId");
                shapedSupplierOfferEntity.ElectronicLockId = (Guid)objectProperty.GetValue(entity);

                objectProperty = entity.GetType().GetProperty("AccessorId");
                shapedSupplierOfferEntity.AccessorId = (Guid)objectProperty.GetValue(entity);
